...
if __name__ == '__main__':
    ...
    url = 'https://uploadstatic.mihoyo.com/ys-obc/2022/05/18/6800286/b1e95edda9749216510990f2b46011b4_1339120471742389492.mp3'
    res = requests.get(url, stream=True)
    if res.status_code == 200:
        with open('music/万叶/想要了解枫原万叶其五.mp3', 'wb') as f:
            for chunk in res.iter_content():
                f.write(chunk)
        f.close()
